...
%        [VT,T] = Tdomain2N(Pt,n,H)
% This function triangulates the polygonal domain 
% with outer boundry points Pt and and inner boundry points H.
...
% Usually, n = 8 seems to be a good choice.
...
% It is updated  by Ming-Jun Lai in July, 2012. 
% It is updated to include any number of Holes by Bree Ettinger in August 2012
warning off
% Empty hole
    if nargin == 2
        H{1} = [];
